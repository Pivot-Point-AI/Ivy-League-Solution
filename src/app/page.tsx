...
export const metadata: Metadata = {
  title: "Ivy League Solutions — Custom IT & AI Solutions for North America",
};
  ...
  return (
    <>
      ...
      <section className="hero" style={{ paddingTop: 140 }}>
        <div className="container">
          <div className="hero-inner">
            <div className="eyebrow">Trusted Across North America</div>
            <h1 className="hero-title font-display">
              Custom Technology<br />Built for <em>Enterprise</em>
            </h1>
            <p className="hero-desc">
              Ivy League Solutions delivers premium custom software, AI systems, and digital
              infrastructure engineered for the North American market — from fintech to healthcare.
            </p>
      ...
      <div className="stats-bar">
        <div className="container">
          <div className="stats-grid">
            {[
              { v: "10+",  l: "Years of Experience", s: "Since 2015" },
              { v: "200+", l: "Projects Delivered",  s: "Across 15 industries" },
              { v: "98%",  l: "Client Satisfaction", s: "Long-term partnerships" },
              { v: "50+",  l: "Expert Engineers",    s: "Global talent" },
            ].map((s) => (
              <div key={s.l} className="stat-item">
                <div className="stat-val font-display">{s.v}</div>
      ...
      <section className="section section-navy">
        <div className="container">
          <div className="sh center">
            <div className="eyebrow" style={{ color: "var(--accent)" }}>Client Voices</div>
            <h2 className="font-display light">Built on <em>Trust & Results</em></h2>
            <div className="rule center" />
          </div>
          <div className="testi-grid">
            {testimonials.map((t) => (
              <div key={t.author} className="testi">
                ...
                <div className="testi-author">
                  ...
                  <div>
                    <div className="auth-name">{t.author}</div>
                    <div className="auth-role">{t.role}</div>
                  </div>
      ...
      <section className="section">
        <div className="container">
          <div className="cta-block">
            <div>
              <h3 className="font-display">Let&apos;s Build Something <em>Exceptional</em></h3>
              <p>Partner with a team that has delivered 200+ enterprise-grade solutions across North America and beyond.</p>
            </div>
            <div className="cta-btns">
              <Link href="/contact" className="btn-navy">Start a Project →</Link>
              <Link href="/solutions" className="btn-outline">View Portfolio</Link>
            </div>
          </div>
        </div>
      </section>
