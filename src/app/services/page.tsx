...
const dts = [
  ...
  { icon: "◉", id: "cybersecurity", title: "Cybersecurity & SOC",   desc: "24/7 threat monitoring, penetration testing, compliance automation and incident response.", tech: ["SOC","Fortinet","Zero Trust","SIEM"] },
  { icon: "◐", id: "cloud-dev",   title: "Cloud & DevOps",          desc: "CI/CD pipelines, containerization, infrastructure-as-code and multi-cloud deployments.", tech: ["AWS","Docker","Kubernetes","Terraform"] },
];
